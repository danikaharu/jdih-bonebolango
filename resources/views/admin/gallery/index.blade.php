...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4">
            <span class="text-muted fw-light">Dashboard /</span> Galeri Kegiatan
        </h4>

        <ul class="nav nav-pills flex-column flex-md-row mb-3">
            <li class="nav-item"><a class="nav-link active" href="{{ route('admin.gallery.create') }}"><i
                        class="bx bx-plus-medical me-1"></i>
                    Tambah Data</a></li>
        </ul>

        <div class="card">
            <h5 class="card-header">List Galeri Kegiatan</h5>
